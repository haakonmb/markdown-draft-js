**NOTICE** :
This is a fork of https://github.com/Rosey/markdown-draft-js to solve a time-sensitive issue. You will probably want to use the version created by Rosey rather than this one, since this package solves a very specific issue for me and probably wont see further independent development.
